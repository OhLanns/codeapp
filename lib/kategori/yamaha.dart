...
class YamahaPage extends StatelessWidget {
      ...
      body: SafeArea(
        child: Container(
          ...
          child: GridView.builder(
            ...
            itemCount: motorYamaha.length,
            itemBuilder: (context, index) {
              final motor = motorYamaha[index];
              ...
              child: Image.asset(
                ...
                errorBuilder: (context, error, stackTrace) {
                  return Container(
                    ...
                    child: Icon(Icons.motorcycle, size: 40, color: isDark ? Colors.grey[400] : Colors.blue),
                  );
                },
              ),
            ),
