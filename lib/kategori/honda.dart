      ...
      body: SafeArea(
        child: Container(
          ...
          child: GridView.builder(
            ...
            itemCount: motorHonda.length,
            itemBuilder: (context, index) {
              final motor = motorHonda[index];
              ...
              child: Image.asset(
                ...
                errorBuilder: (context, error, stackTrace) {
                  return Container(
                    height: 120,
                    width: double.infinity,
                    color: isDark ? Colors.grey[700] : Colors.red[50],
                    child: Icon(Icons.motorcycle, size: 40, color: isDark ? Colors.grey[400] : Colors.red),
                  );
                },
              ),
            ),
